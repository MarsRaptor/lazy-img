/*!
 * lazy-img - Lazy loading <img/> elements
 *
 ...
 * @typedef {{init({lazy_src:string, loading_src:string},lazy_image_init_options|undefined):forceLoad,forceLoad:forceLoad}} lazy_img
 */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
        typeof define === 'function' && define.amd ? define(factory) :
            (global = global || self, global.lazy_img = factory());
}(this, function () {
    ...
    const lazy_img = {
        ...
        /**
         * Force loading on all defined lazy images
         */
        forceLoad() {
